...
\begin{document}
	...
	\section*{Análisis}
Se el circuito con amplificador operacional de la figura 1. Determine cada una de las siguientes condiciones:

\begin{itemize}
	\item Exprese $V_1$ en términos de $V_{I_1}$ y $V_{I_2}$. Considere que el potenciómetro $R7$ está fijado de tal manera que hay $\qty{10}{\kilo \ohm}$ en la parte superior y $\qty{15}{\kilo \ohm}$ en la parte inferior.
	\item Si $V_{I_1} = \qty{2}{\volt}$, $V_{I_2} = \qty{1}{\volt}$, el potenciómetro $R_7$ está en la posición central y el potenciómetro $R_{10}$ está en posición central, grafique el voltaje de $V_o$ vs $t$.
	\item  Si $V_{I_1} = \qty{2}{\volt}$, $V_{I_2} = \qty{1}{\volt}$, el potenciómetro $R_7$ está en la posición central y el potenciómetro $R_{10}$ está totalmente en la parte superior , grafique el voltaje $V_o$ vs $t$.
\end{itemize}
...
\section{Ejemplo 1}
Sea el circuito de la figura 1, y sean los siguiente valores:

\begin{align}
	R_1 = \qty{5}{\kilo \ohm} \quad R_2 = \qty{5}{\kilo \ohm} \quad R_3 = \qty{20}{\kilo \ohm} \quad R_4 = \qty{15}{\kilo \ohm} \quad R_5 = \qty{10}{\kilo \ohm} \quad R_6 = \qty{20}{\kilo \ohm} \quad R_7 = \qty{25}{\kilo \ohm} \nonumber \\
	R_8 = \qty{10}{\kilo \ohm} \quad R_9 = \qty{2}{\kilo \ohm} \quad R_{10} = \qty{20}{\kilo \ohm} \quad R_{11} = \qty{75}{\kilo \ohm} \quad V_D = \qty{0.5}{\volt}, V_{CC} = \qty{15}{\volt} \quad V_{EE} = \qty{-15}{\volt} \nonumber \\
	\alpha = 0.4 \quad \alpha_1 = 0.5 \nonumber  \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad
\end{align}

Halle el voltaje de salida $V_{o_1}$ y grafique la forma de onda de salida $V_o$ respecto al tiempo

\subsection{Solución}

Utilizamos la ecuación (13) para calcular el voltaje de salida en el primer amplificador

\begin{align}
V_{o_1} = \left( 1 + \frac{R_3}{R_1} \right) \left( \frac{R_4 + R_{th_2}}{R_2 + R_4 + R_{th_2}} \right)V_{I_1} -\frac{R_3}{R_1}V_{I_2} + \left( 1 + \frac{R_3}{R_1} \right) \left( \frac{R_2}{R_2 + R_4 + R_{th_2}} \right)V_{th_2} = \qty{4.9286}{\volt}	
\end{align}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[smooth, magenta,thick, mark=none, domain=0:0.3, samples=500] {-52.8571*x};
