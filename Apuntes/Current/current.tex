...
\begin{document}
	...
	Sabemos que en situaciones electrostáticas (cargas eléctricas en reposo) no puede haber un campo eléctrico \boldmath{$\vec{E}$} en el interior de un material conductor, de otra manera las cargas móviles en el conductor se moverían y la situación ya no sería electrostática.
	
	Una corriente (también llamada \textit{corriente eléctrica})
