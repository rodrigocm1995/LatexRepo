...
El rectificador de media onda con carga $R-L$ se muestra en la figura 1. Durante la condición del diodo se puede desarrollar la siguiente equación:
\begin{figure}[H]
	\centering
...
\begin{info} % Information block
	...
	Donde $a_1(x)$, $a_0(x)$ y $b(x)$ dependen sólo de la variable independiente $x$, no de $y$. Esta ecación se puede escribir en su forma estándar.
	\begin{equation}
