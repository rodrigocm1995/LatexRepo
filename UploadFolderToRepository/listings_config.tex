...
\lstdefinelanguage{CMakeVSCode}{
	morekeywords=[1]{
		...
		enable_language, add_executable, add_subdirectory, 
		target_link_directories, target_sources, target_include_directories, 
		target_compile_definitions, list, target_link_libraries
	},
	morekeywords=[2]{
		VERSION, PRIVATE, REQUIRED, ON, TRUE, STATUS, static, void, double
	},
	morekeywords=[3]{ 
